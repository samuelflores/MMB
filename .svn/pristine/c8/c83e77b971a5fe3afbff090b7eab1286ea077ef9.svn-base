...
class  MMB_EXPORT MobilizerStretch : public ResidueStretch  {
        ...
        String getBondMobilityString() {
                    ...
                    /*
            if (BondMobility == BondMobility::Rigid) {
            return "Rigid";
            } else if (BondMobility == BondMobility::Torsion) {
            return "Torsion";
            } else if (BondMobility == BondMobility::Free) {
            return "Free";
            } else if (BondMobility == BondMobility::Default) {
            return "Default";
            } else {
            ErrorManager::instance <<__FILE__<<":"<<__LINE__<<" Unable to retrieve Bond Mobility!"<<endl;
            ErrorManager::instance.treatError();
            }*/   
                };
