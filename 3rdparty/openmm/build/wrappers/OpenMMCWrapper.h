...
typedef struct OpenMM_BAOABLangevinIntegrator_struct OpenMM_BAOABLangevinIntegrator;
...
extern OPENMM_EXPORT OpenMM_BAOABLangevinIntegrator* OpenMM_BAOABLangevinIntegrator_create(double temperature, double frictionCoeff, double stepSize);
extern OPENMM_EXPORT void OpenMM_BAOABLangevinIntegrator_destroy(OpenMM_BAOABLangevinIntegrator* target);
extern OPENMM_EXPORT double OpenMM_BAOABLangevinIntegrator_getTemperature(const OpenMM_BAOABLangevinIntegrator* target);
extern OPENMM_EXPORT void OpenMM_BAOABLangevinIntegrator_setTemperature(OpenMM_BAOABLangevinIntegrator* target, double temp);
extern OPENMM_EXPORT double OpenMM_BAOABLangevinIntegrator_getFriction(const OpenMM_BAOABLangevinIntegrator* target);
extern OPENMM_EXPORT void OpenMM_BAOABLangevinIntegrator_setFriction(OpenMM_BAOABLangevinIntegrator* target, double coeff);
extern OPENMM_EXPORT int OpenMM_BAOABLangevinIntegrator_getRandomNumberSeed(const OpenMM_BAOABLangevinIntegrator* target);
extern OPENMM_EXPORT void OpenMM_BAOABLangevinIntegrator_setRandomNumberSeed(OpenMM_BAOABLangevinIntegrator* target, int seed);
extern OPENMM_EXPORT void OpenMM_BAOABLangevinIntegrator_step(OpenMM_BAOABLangevinIntegrator* target, int steps);
