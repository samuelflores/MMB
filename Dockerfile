...
RUN apt-get update && apt-get install -y  subversion     cmake    cmake-curses-gui    g++    vim    doxygen    swig python  libblas-dev liblapack-dev  git-core apache2  subversion libapache2-mod-svn  libsvn-dev
