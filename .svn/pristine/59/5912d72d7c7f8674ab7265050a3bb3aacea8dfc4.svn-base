...
;
                ...
                for (int r=0; r<4; r++) {
	            inFile.getline( s, 100,',' );
	            (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).bondLength[r] =   (double)atof(s);
                } 
                for (int r=0; r<4; r++) {
	            inFile.getline( s, 100,',' );
	            (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).springConstant[r] = (double)atof(s);
                } 
	        inFile.getline(s,100,',');
	        (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).torqueConstant =  (double)atof(s);
		assert ((myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).torqueConstant >= 0);
                for (int r=0; r<3; r++) {
	            inFile.getline( s, 100,',' );
	            (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).attachmentPoint[r] = atof(s);
                }
                inFile.getline( s, 100,',' );
                (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).rotationAngle = (double)atof(s);
                for (int r=0; r<3; r++) {
	            inFile.getline( s, 100,',' );
	            (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).rotationAxis[r] = atof(s);
                }
                ...
                inFile.getline( s, 100,',' );
                (myLeontisWesthofBondMatrix.myLeontisWesthofBondRow[q]).distanceC1pC1p = (double)atof(s);
