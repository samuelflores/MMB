...
public:
        ...
        void addGappedThreading(String chain1, String chain2, double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer,double gapPenalty, String scoringScheme);
        void addGappedThreading(String chain1, ResidueID startResidue1,  ResidueID endResidue1,   String chain2, ResidueID startResidue2,  ResidueID endResidue2,  double forceConstant, bool backboneOnly,
                                       BiopolymerClassContainer & myBiopolymerClassContainer,double gapPenalty, String scoringScheme);
        ...
        void updateGappedThreading(int id, String chain1, String chain2, double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer,double gapPenalty, String scoringScheme);

        static ThreadingStruct createGappedThreading(String chain1, String chain2, double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer1,  BiopolymerClassContainer & myBiopolymerClassContainer2,double gapPenalty, String scoringScheme );

        static ThreadingStruct createGappedThreading(String chain1, String chain2, double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer,double gapPenalty, String scoringScheme) {return createGappedThreading( chain1,  chain2,  forceConstant, backboneOnly,  myBiopolymerClassContainer,   myBiopolymerClassContainer, gapPenalty,  scoringScheme);}; // For backward compatibility. Just calls its two-BiopolymerClassContainer counterpart with both BiopolymerClassContainer's set to the same object.
        static ThreadingStruct createGappedThreading(String chain1, ResidueID startResidue1,  ResidueID endResidue1, String chain2,  ResidueID startResidue2,  ResidueID endResidue2,  double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer1,BiopolymerClassContainer & myBiopolymerClassContainer2,double gapPenalty, String myScoringScheme    ) ;
        static ThreadingStruct createGappedThreading(String chain1, ResidueID startResidue1,  ResidueID endResidue1, String chain2,  ResidueID startResidue2,  ResidueID endResidue2,  double forceConstant, bool backboneOnly, BiopolymerClassContainer & myBiopolymerClassContainer,double gapPenalty, String scoringScheme) {return createGappedThreading(chain1, startResidue1,  endResidue1, chain2,  startResidue2,   endResidue2,  forceConstant, backboneOnly,  myBiopolymerClassContainer ,  myBiopolymerClassContainer, gapPenalty,  scoringScheme);}; // For backward compatibility. Just calls its two-BiopolymerClassContainer counterpart with both BiopolymerClassContainer's set to the same object.
